...
namespace Naidis_IKTpv25
{
    public class Osa2_funktisoonid
    {
        ...
        public static void KontrolliPinginaabreid()
        {
            string nimi1, nimi2;
            ...
            {
                Console.WriteLine("Sisesta esimene nimi: ");
                nimi1 = Console.ReadLine().Trim();

                Console.WriteLine("Sisesta teine nimi: ");
                nimi2 = Console.ReadLine().Trim();
            }
            catch (Exception)
            {
                Console.WriteLine("Viga: nime sisestamine ebaõnnestus.");
                return;
            }
            ...
            foreach (var paar in pinginaabridList)
            {
                if (paar == $"{nimi1} ja {nimi2}" || paar == $"{nimi2} ja {nimi1}")
                {
                    leitud = true;
                    break;
                }
            ...
            if (leitud)
                ...
                Console.WriteLine($"{nimi1} ja {nimi2} EI OLE pinginaabrid.");
        }
        ...
        public static void RemondiKalk()
        {
            ...
            {
                Console.WriteLine("Viga: sisesta palun korrektne arv.");
            }
        }
        ...
        public static void temperatuur()
        {
            ...
            {
                Console.WriteLine("Viga: sisesta palun korrektne temperatuur.");
            }
        }
        public static void inimPikkus()
        {
            ...
            {
                Console.WriteLine("Viga: sisesta palun täisarv.");
            }
        }
        public static void inimPikkusJaSugu()
        {
            ...
            {
                Console.WriteLine("Viga: pikkus peab olema täisarv.");
            }
        }
